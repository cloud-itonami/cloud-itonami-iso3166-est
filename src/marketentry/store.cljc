(ns marketentry.store
  "SSoT for the Estonia (EST) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:signing-method` is ground truth for the `signing-method-invalid`
  flagship check (Estonia's closed set of nationally-recognised
  ...
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Tallinna Tehnika OÜ" :portal "riigihanked.riik.ee"
    ...
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "riigihanked.riik.ee"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :signing-method :id-card
    ...
    "eng-3" {:id "eng-3" :operator "Tartu Digilahendused OÜ" :portal "riigihanked.riik.ee"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "EST" :status :intake}
    "eng-4" {:id "eng-4" :operator "Nordic Baltic Solutions OÜ" :portal "riigihanked.riik.ee"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "EST" :status :intake}
    "eng-5" {:id "eng-5" :operator "Pärnu Ehitus AS" :portal "riigihanked.riik.ee"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-est"})
